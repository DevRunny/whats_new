...
const feedbackReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case SET_ACTIVE_SLIDE: {
      return {
        ...state,
        slides: { ...state.slides, activeSlide: { ...action.payload, currentSlide: action.currentSlide } }
      };
    }
    case CHANGE_CURRENT_SLIDE: {
      return {
        ...state,
        slides: { ...state.slides, activeSlide: { ...state.slides.activeSlide, currentSlide: action.payload } }
      };
    }
